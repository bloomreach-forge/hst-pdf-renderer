          ...
          <div class="container">
            ...
            <div class="nav-collapse">
              <ul class="nav pull-right">
                ...
                <li>
                  <c:if test="${not empty hstRequest.requestContext.contentBean}">
                    <div id="pdflink">
                      <a href='<hst:link mount="pdf" hippobean="${hstRequest.requestContext.contentBean}"/>'>
                        <img src="<hst:link path="/images/pdf.png"/>" border="0" />
                      </a>
                    </div>
                  </c:if>
                </li>
