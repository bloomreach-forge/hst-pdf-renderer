package org.onehippo.forge.hstpdfrenderer.demo.componentsinfo;
...
public interface GeneralListInfo  {
    ...
    @Parameter(name = "docType", displayName = "Document Type", defaultValue="hstpdfrendererdemo:basedocument")
    String getDocType();
